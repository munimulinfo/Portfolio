...
import logo3 from '../assets/student.svg'
...
const AboutMe = () => {
    return (
        <div className='flex items-center'>
          ...
          <Typewriter
            words={[' Habibur Rahman.', ' Frontend Developer.']}
            loop={5}
            cursor
            cursorStyle='_'
            typeSpeed={70}
          ...
          />
               ...
               <p className='mt-10'>Hi, I'm Habib, a passionate Frontend Developer with experience in building user-friendly and visually appealing web applications. I thrive on creating seamless user experiences and transforming design concepts into functional websites.
